...
import "./PaymentOrderDetails.css";

function formatDate(value?: string): string {
  if (!value) return "";
  const d = new Date(value);
  if (isNaN(d.getTime())) return "";
  // Match Angular DatePipe default ('mediumDate') -> e.g. "Jun 16, 2024"
...
export function PaymentOrderDetailsPage() {
  ...
  return (
    <>
      <div className="title-container details-title">
        <Link to="/payment-orders" className="p-button link" aria-label="Back">
